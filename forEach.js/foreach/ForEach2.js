...
students.forEach((student,index)=>{
    console.log(`O aluno se chama ${student.name}, tem ${student.age}, e esta na posição ${index} do array ` ) //dessa forma ele vai mostrar mais detalhado a idade de cada um ,nome e posição.
} )
